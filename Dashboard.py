...
# Load CSV files from the data folder	 data
grant_df = pd.read_csv("datasets/Grant.csv")

person_df = pd.read_csv("datasets/Person.csv")
institute_df = pd.read_csv("datasets/Institute.csv")
grant_to_person_df = pd.read_csv("datasets/GrantToPerson.csv")
grant_to_discipline_df = pd.read_csv("datasets/GrantToDiscipline.csv")
discipline_df = pd.read_csv("datasets/Discipline.csv")
grant_keyword_df = pd.read_csv("datasets/GrantToKeyword.csv")
keyword_df = pd.read_csv("datasets/Keyword.csv")
...
# --------------------------- Collaboration Network ---------------------------
    ...
    st.image("datasets/sna1.png", use_container_width=True)
